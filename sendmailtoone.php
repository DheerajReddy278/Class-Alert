            ...
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    <input type="text" name="subject" class="form-control" placeholder="Subject" required="">
                        ...
                        <br>
                        <input type="text" name="rollno" class="form-control" placeholder="Enter student roll no." required="">
                        <br>
                        <div class="form-group form-button">
                            <input type="submit" name="sendtoone" id="sendtoone" class="btn btn-primary" value="Send"
                                action="mailtoonescript.php" />
                        </div>
                    </form>
                </div>
